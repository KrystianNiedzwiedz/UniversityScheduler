...
window.CATALOG_SERVICE_URL = 'http://localhost:5090'
window.CATALOG_ITEMS_API_URL = `${window.CATALOG_SERVICE_URL}/courses`
window.INVENTORY_SERVICE_URL = 'http://localhost:5041'
window.INVENTORY_ITEMS_API_URL = `${window.INVENTORY_SERVICE_URL}/courses`
